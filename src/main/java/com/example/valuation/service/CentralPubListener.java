...
public class CentralPubListener {
    ...
    private final BlockingQueue<String> bufferQueue = new LinkedBlockingQueue<>(QUEUE_CAPACITY);
    ...
    public void fetchAndBufferMessages() {
        ...
        List<String> newMessages = allMessages.subList(lastFetchedSize, currentSize);
    ...
    public void processBatch() {
        ...
        try {
            ...
            for (CanonicalTradeDTO trade : trades) {
                try {
                    ValuationEntity valuation = valuationService.valuation(trade);
